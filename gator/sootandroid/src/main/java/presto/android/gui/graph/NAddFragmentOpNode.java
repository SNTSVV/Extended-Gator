/*
 * NAddFragmentOpNode.java - part of the GATOR project
 *
...
public class NAddFragmentOpNode extends NOpNode {
    public NAddFragmentOpNode(NNode idNode, NVarNode fragment,  NNode receiverNode,
