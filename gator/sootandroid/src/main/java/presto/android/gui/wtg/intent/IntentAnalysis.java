...
public class IntentAnalysis {
  ...
  private void resolveApproximateIntent() {
    ...
    //Logger.verb("DEBUG","[IntentAnalysis] resolveApproximateIntent");
    ...
    while (goOn) {
      ...
      //Logger.verb("DEBUG","[IntentAnalysis] doAnalysis");
      goOn = doAnalysis();
    }
    postAnalysis();
  ...
  private void resolvePartialPreciseIntent(
    ...
    boolean goOn = true;
    int count=0;
    //Logger.verb("DEBUG","[IntentAnalysis] resolvePartialPreciseIntent");
    while (goOn) {
      goOn = false;
      count++;
      // step 1: prepare the data for intent analysis
  ...
  private void resolveStartActivityIntentContent() {
    ...
    //Logger.verb("DEBUG", "[IntentAnalysis] intentFlowtoSetIntentContent size: "+intentFlowtoSetIntentContent.size());
...
//    Logger.verb("DEBUG", "[IntentAnalysis] Working List: "+workingList.size());
